...
```
admin:run sql select name,description,fkenduser from device where tkclass = '1' and not (tkmodel = '72' or tkmodel = '645')
name            description                     fkenduser
=============== =============================== ====================================
CSFJHAWKINS     James Hawkins Jabber CSF        8c758cf4-da8c-bd00-53be-a0902f1707e1
TCTJHAWKINS     James Hawkins Jabber for iPhone NULL
TABJHAWKINS     James Hawkins Jabber for iPad   NULL
